...
PICS = (environ.get('PICS', 'https://envs.sh/EB2.jpg?=ilovSTARLEY')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '800422840 6489691371').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002524861072 -1002833828931').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://anu:anu@cluster0.p49cylp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002904147475'))
